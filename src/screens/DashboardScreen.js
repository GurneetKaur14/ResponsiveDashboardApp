...
const DashboardScreen = () => {
  ...
  // State: device orientation ('portrait' or 'landscape')
  const [orientation, setOrientation] = useState('portrait');

  // Sample dashboard data for statistics
   ...
   * Simulates data update with setTimeout
   */
    ...
    setTimeout(() => {
      setDashboardData(prev => ({
        ...
        statistics: prev.statistics.map(stat => ({
          ...stat,
          value: stat.id === 1 ? '$25.2K' : stat.value, // Example: update total sales
        })),
      }));
      setRefreshing(false);
    }, 2000);
  ...
  /**
   * Render a single statistic widget
   */
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <ResponsiveGrid
          ...
          // Adjust number of columns based on orientation and device type
          numColumns={
            isLandscape && isTab
              ? 4
              : isLandscape
